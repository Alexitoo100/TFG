...
JOIN juegos_desarrolladoras AS jd on juegos.id=jd.id_juegos JOIN desarrolladoras AS d on d.id=jd.id_desarrolladoras WHERE precio BETWEEN '$precioMin' AND '$precioMax'";
